...
const config = getProblemConfig("homework-stress");

export default function HomeworkStressPage() {
  return (
    <CinematicStory
      ...
      primaryCtaHref={config.primaryCtaHref ?? `/problems/homework-stress/handle-it`}
